<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Maxim Options', 'redux-framework-demo' ),
        'page_title'           => __( 'Maxim Options', 'redux-framework-demo' ),
...
Redux::setSection($opt_name, array(
    'title' => 'Maxim All Logo',
    'id' => 'mxim_logo',
    'fields' => array(
        array(
            'id'=> 'text_logo',
    'title' => 'Maxim Text Logo',
    'type' => 'text',
        ),
    
    array(
            'id'=> 'img_logo',
    'title' => 'Maxim Image Logo',
    'type' => 'media',
        ),
...
Redux::setSection($opt_name, array(
  'title' => 'Maxim slider background',
  'id'    => 'maxim_slider_background',
 'fields' => array(
    array(
        'id' => 'maxim_slider_background_field',
         'title' => 'Maxim slider background',
         'type'  => 'background',
    ),
     ...
     array(
        'id' => 'maxim_background_opacity',
         'title' => 'Maxim Background Opacity',
         'type'  => 'color_rgba',
...
Redux::setSection($opt_name, array(
  'title' => 'Maxim Blockquote',
  'id'    => 'maxim_slider_blockquote',
  'icon'    => 'el el-info-circle',
 'fields' => array(
    array(
        'id' => 'maxim_blockquote_field',
         'title' => 'Maxim Blockquote Field',
         'type'  => 'textarea',
    ), 
    array(
        'id' => 'maxim_blockquote_name',
         'title' => 'Maxim Blockquote Name',
         'type'  => 'text',
    ), 
    array(
        'id' => 'maxim_blockquote_icon',
         'title' => 'Maxim Blockquote Icon',
         'type'  => 'text',
    ), 
 ),
